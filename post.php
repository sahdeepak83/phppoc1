    ...
    foreach ($xmlarray as $key=>$val){
		...
		if(empty($val['notifications']['Notification'][0])){
			...
			foreach($val as $fdata){
				...
				$RecordTypeId = isset($fdata['Notification']['sObject']['RecordTypeId']) ? $fdata['Notification']['sObject']['RecordTypeId'] : 'null';
			...
			foreach($val['notifications']['Notification'] as $fdata){
				...
				$RecordTypeId = isset($fdata['sObject']['RecordTypeId']) ? $fdata['sObject']['RecordTypeId'] : 'null';
